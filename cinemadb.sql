...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2026. Jan 12. 07:41
...
--
-- Tábla szerkezet ehhez a táblához `film_type`
--
...
--
-- A tábla adatainak kiíratása `film_type`
--

INSERT INTO `film_type` (`type_id`, `type_name`) VALUES
(1, 'Action'),
(2, 'Comedy'),
(3, 'Drama'),
(4, 'Sci-Fi'),
...
CREATE TABLE IF NOT EXISTS `movies` (
  ...
  KEY `actor_id` (`actor_id`,`film_type_id`),
  KEY `film_type_id` (`film_type_id`)
...
--
ALTER TABLE `movies`
  ADD CONSTRAINT `movies_ibfk_1` FOREIGN KEY (`film_type_id`) REFERENCES `film_type` (`type_id`),
  ADD CONSTRAINT `movies_ibfk_2` FOREIGN KEY (`actor_id`) REFERENCES `actors` (`actor_id`) ON DELETE CASCADE;
COMMIT;
